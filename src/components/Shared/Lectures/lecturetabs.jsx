      ...
      <div className="lecturetabs tabs is-centered is-boxed">
        <ul className="lecturetabs__ul">
          <li className="lecturetabs__li ">
            <NavLink
              className="lecturetabs__link"
              activeClassName="lecturetabs__li--is-active"
              to={`/dashboardlectures/${1}/lectures`}
            >
          ...
          <li className="lecturetabs__li">
            <NavLink
              className="lecturetabs__link"
              activeClassName="lecturetabs__li--is-active"
              to={`/dashboardlectures/${1}/assignments`}
            >
              <span className="lecturetabs__spanicon icon is-small">
          ...
          <li className="lecturetabs__li">
            <NavLink
              className="lecturetabs__link"
              activeClassName="lecturetabs__li--is-active"
              to={`/dashboardlectures/${1}/recording`}
            >
              <span className="lecturetabs__spanicon icon is-small">
                <i
                  className="lecturetabs__icon fas fa-film"
                  aria-hidden="true"
                ></i>
              </span>
